...
const StarItemResult = ({
    ...
    return (
        <div className={'stars-s5-game__star _result' + (pickedStars.includes(starId) ? ' _active' : '') + (resultNumber === starId ? ' _win' : '') + (resultNumber === starId && betAmount * betMultiply > 99 ? ' _long' : '')}>
