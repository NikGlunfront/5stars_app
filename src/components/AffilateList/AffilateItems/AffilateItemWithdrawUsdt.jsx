...
const AffilateItemWithdrawUsdt= ({
    withdrawData,
    tonRate
}) => {
    ...
    return (
        <div className="history-item history-item_withdraw_usdt">
                ...
                <div className="history-item__left">
                    ...
                    <div className="history-item__changes">
                        <div className="history-item__spend">
                            <div className={isPremium ? "history-game-result-usdt _active _win" : "history-game-result-coin _active _win"}></div>
                            <span>{amount}</span>
                        </div>
                    </div>
...
export default AffilateItemWithdrawUsdt
