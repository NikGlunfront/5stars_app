...
export const attemptsSlice = createSlice({
    ...
    initialState,
    reducers: {
        shuffleAttBonuses: (state, action) => {
        ...
        revealAttBonusResult: (state, action) => {
            return {
                ...state, 
        ...
        revealAttPrizeResult: (state, action) => {
            return {
                ...state, 
        ...
        setAttPickedPrizeStar: (state, action) => {
            return {
                ...state, pickedStarPrize: action.payload
            }
        },
        setAttBonusFromHistory: (state, action) => {
            return {
                ...state,
        ...
        setAttPrizesFromHistory: (state, action) => {
            return {
                ...state,
...
export const {
    shuffleAttBonuses,
    revealAttBonusResult,
    setAttBonusFromHistory,
    setAttIsVisibleBonus,
    resetAttBonus,
    shuffleAttPrizes,
    revealAttPrizeResult,
    setAttPrizesFromHistory,
    setAttPickedPrizeStar,
    resetAttPrize
