    ...
    return (
        <div className='stars-s5-game__bet stars-s5-game__bet_bonus'>
            {activeBonusGame.map(star => (
                <div key={star.id} className={'stars-s5-game__star stars-s5-game__star_bonus' + (pickedStar === star.id ? ' _active' : '') + (star.value > 99 ? ' _long' : '') + (isBonusGameFinished ? ' _finished' : "")} onClick={() => betClick(star.id)}>
