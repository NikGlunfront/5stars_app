...
import starWin from '../../assets/img/icons/game/bets/star_item_purple.png'
    ...
    return (
        <div className='stars-s5-game__bet'>
            {activeGamePrize.map(star => (
                <div key={star.id} className={'stars-s5-game__star stars-s5-game__star_bonus' + (pickedStar === star.id ? ' _active' : '') + (star.value > 99 ? ' _long' : '') + (isGamePrizeFinished ? ' _finished' : "")} onClick={() => betClick(star.id)}>
